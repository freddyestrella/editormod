...
{
    public class XG_RadioGroup : XG_Control
    {
        XGValueChangedEvent valueChangedEvent = null;

        public XG_RadioGroup(Rectangle rect, string text)
            : base(rect, true)
        {
            Text = text;
        }

        public XG_RadioGroup(Rectangle rect, string text, XGValueChangedEvent checkChangedEventHandler)
            : base(rect, true)
        {
            Text = text;
        ...
        public int SelectedIndex
        {
            ...
            set
            {
                if (value < 0 || value >= Children.Count)
                    throw new IndexOutOfRangeException("SelectedIndex Out of Range in XG_RadioGroup");
        ...
        public override void Draw(float frameTime)
        {
            ...
            XnaGUIManager.spriteBatch.Draw(XnaGUIManager.WhiteRect, rect, ThisControlColor);
    ...
    public class XGRadioButton : XG_Control
    {
        ...
        public bool Checked 
        {
            ...
            set
            {
                ...
                if (_checked)
                {
                    XG_RadioGroup group = Parent as XG_RadioGroup;
                    if (group != null)
        ...
        public override void Draw(float frameTime)
        {
            ...
            XnaGUIManager.spriteBatch.Draw(XnaGUIManager.WhiteRect, top, ThisForeColor);
            XnaGUIManager.spriteBatch.Draw(XnaGUIManager.WhiteRect, left, ThisForeColor);
            XnaGUIManager.spriteBatch.Draw(XnaGUIManager.WhiteRect, right, ThisForeColor);
            XnaGUIManager.spriteBatch.Draw(XnaGUIManager.WhiteRect, bottom, ThisForeColor);
            ...
            {
                rect.Inflate(-4, -4);
                XnaGUIManager.spriteBatch.Draw(XnaGUIManager.WhiteRect, rect, ThisForeColor);
            }
