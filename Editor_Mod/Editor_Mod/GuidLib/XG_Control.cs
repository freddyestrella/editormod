...
{
    public delegate void XGValueChangedEvent(XG_Control sender);

    public class XGControlCollection : List<XG_Control>
    {
        internal XG_Control Parent;

        internal XGControlCollection(XG_Control owner)
        {
            Parent = owner;
        }

        public new void Add(XG_Control control)
        {
        ...
        public new void Insert(int index, XG_Control control)
        {
            control.Parent = Parent;
        ...
        public new void Remove(XG_Control control)
        {
            base.Remove(control);
    ...
    public abstract class XG_Control
    {
        public XG_Control Parent { get; set; }
        public XGControlCollection Children;
        public Rectangle Rectangle { get; set; }
        public bool Visible { get; set; }
        public bool Enabled { get; set; }
        public object Tag { get; set; }
        protected XG_Control focusControl = null;
        public bool CanFocus { get; set; }
        public string Text { get; set; }
        private static int cnt = 0;
        public GUIAlignment Alignment { get; set; }
        public Vector2 Padding = new Vector2(2, 2);
        public static Color _controlColor; // (enabled, no focus)
        public static Color _controlDarkColor; // (disabled)
        public static Color _controlHiColor; // (enabled, focus)
        public static Color _foreColor; // (enabled, no focus)
        public static Color _foreHiColor; // (enabled, focus)
        public static Color _foreDarkColor; // (disabled)
        ...
        public static Color ControlColor 
        {
            ...
            { 
                _controlColor = value;
                _controlDarkColor = Color.Lerp(Color.Black, value, Mod.ControlColorValue);
                _controlHiColor = Color.Lerp(value, Color.White, Mod.ControlColorValue);
            } 
        }
        ...
        public static Color ForeColor 
        {
            ...
            {
                _foreColor = value;
                _foreDarkColor = Color.Lerp(Color.Black, value, Mod.ForeColorValue);
                _foreHiColor = Color.Lerp(value, Color.White, Mod.ForeColorValue);
            }
        }
        ...
        public XG_Control(Rectangle rect, bool canFocus)
        {
            ...
            cnt++;
            Text = "XG_Control" + cnt.ToString();
         //  // ControlColor = new Color(0, 139, 0, 0);
           // ForeColor = new Color(0, 255, 255, 255);
          //  BkgColor = new Color(0, 0, 139, 255);
            ForeColor = Mod.FontColor;
            ControlColor = Mod.ControlColor;
            BkgColor = Mod.BkgColor;
        ...
        public static Vector2 GetTextPosition(Rectangle rect, string Text, GUIAlignment Alignment, Vector2 Padding)
        {
            ...
            size.Y = XnaGUIManager.spriteFont.MeasureString("angle").Y;
        ...
        public XG_Control GetFocusControl()
        {
        ...
        public bool IsParent(XG_Control control)
        {
            if (Parent == null)
                return false;
        ...
        internal virtual void Activate()
        {
            ...
            {
                foreach (XG_Control child in Children)
                {
        ...
        internal virtual bool ActivateNext(XG_Control current)
        {
        ...
        internal virtual bool ActivatePrevious(XG_Control current)
        {
            int index = Children.IndexOf(current);
        ...
        /// <summary>
        /// Activates start child that CanFocus or self if CanFocus
        /// </summary>
        /// <returns></returns>
        ...
        public virtual void Update(GameTime gameTime)
        {
            ...
            foreach (XG_Control control in Children)
            {
                if (control.Enabled)
        ...
        public static void DrawBorder(Rectangle rect, int width, Color color, bool drawTop)
        {
            ...
            if (drawTop)
                XnaGUIManager.spriteBatch.Draw(XnaGUIManager.WhiteRect, top, color);
            XnaGUIManager.spriteBatch.Draw(XnaGUIManager.WhiteRect, left, color);
            XnaGUIManager.spriteBatch.Draw(XnaGUIManager.WhiteRect, right, color);
            XnaGUIManager.spriteBatch.Draw(XnaGUIManager.WhiteRect, bottom, color);
