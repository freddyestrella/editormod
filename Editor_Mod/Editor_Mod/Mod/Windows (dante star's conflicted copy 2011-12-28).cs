...
public XG_ButtonLabelBool Fill { get; set; }
    ...
    public class ServerCommand4 : XG_TabPage
    {
            ...
            : base(rect, "SC4")
        {
            ...
            Children.Add(new XG_Button(new Rectangle(10, 5, 80, 20), "set temp 1", this.set1_Clicked));
            Children.Add(new XG_Button(new Rectangle(100, 5, 80, 20), "set temp 2", this.set2_Clicked));
            ...
            Children.Add(new XG_Button(new Rectangle(200, 35, 60, 20), "allow", this.allow_Clicked));
            Children.Add(new XG_Button(new Rectangle(300, 35, 60, 20), "list", this.list_Clicked));

            Children.Add(new XG_Button(new Rectangle(10, 60, 100, 20), "get region", this.getname_Clicked));
            Region = new XGTextBox(new Rectangle(10, 90, 150, 20));
            Region.Text = "Region name";
            Children.Add(Region);

            Children.Add(new XG_Button(new Rectangle(200, 60, 100, 20), "get player", this.getnamefromp_Clicked));
        ...
        {   
            NetMessage.SendData(25, -1, -1, @"/region allow "+  player.Text + " " + Region.Text);

        }
        void gen_Clicked(XG_Control sender)
        {
            NetMessage.SendData(25, -1, -1, @"/region " + sender.Text + " " + Region.Text);
        ...
        void getnamefromp_Clicked(XG_Control sender)
        {
            ...
            player.Text = Mod.SelectedPlayer.name;
                ...
                if (!Mod.polygons.onwindow)
                {
                    if (Main.netMode == 1)
                    {
                        ...
                        if (getname)
                        {
                            ...
                            NetMessage.SendData(17, -1, -1, "", 10, (float)Mod.MouseOnMap.X, (float)Mod.MouseOnMap.Y, 0f, 0);
                            findname = true;
                            getname = false;
                        }
                    ...
                    if (words.Length >= 3)
                    {
                        if (words[0] == "Region")
                        {
                            ...
                            if (words[1] == "Name:")
                            {
                                ...
                                RegionName = Mod.addquotes(Arguments);
                                findname = false;
                                break;
                            }
                        }
