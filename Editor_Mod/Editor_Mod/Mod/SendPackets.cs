    ...
    public class SendPackets
    {
        ...
        public static void SendData(int msgType, int remoteClient = -1, int ignoreClient = -1, string text = "", int number = 0, float number2 = 0f, float number3 = 0f, float number4 = 0f, int number5 = 0)
        {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        if (msgType == 100 + 7)
                                        {
                                            ...
                                            byte b11 = 0;
                                            if (Editor_Mod.WorldGenReflect.shadowOrbSmashed)
                                           {
                                             b11 += 1;
                                           }
                                            if (NPC.downedBoss1)
                                                                                                ...
                                                                                                else
                                                                                                {
                                                                                                    ...
                                                                                                    else
                                                                                                    {
                                                                                                        if (msgType == 100 + 23)
                                                                                                        {
                                                                                                            ...
                                                                                                            byte[] bytes123 = BitConverter.GetBytes(number2);
                                                                                                            byte[] bytes124 = BitConverter.GetBytes(number3);                                                                                
                                                                                                            byte[] bytes115 = Encoding.ASCII.GetBytes(text);
                                                                                                            //header
                                                                                                            num2 += 1 + bytes123.Length + bytes124.Length + bytes115.Length;
            ...
            IL_3F79:
                if (remoteClient == -1)
                {
                    if (msgType == 100 + 20)
                    {
                        ...
                        {
                            if (num14 != ignoreClient && (NetMessage.buffer[num14].broadcast || (Netplay.serverSock[num14].state >= 3 && msgType == 100 + 10)) && Netplay.serverSock[num14].tcpClient.Connected && Netplay.serverSock[num14].SectionRange(number, (int)number2, (int)number3))
                            {
                                try
                                {
                    ...
                    if (msgType == 100 + 28)
                    {
                        ...
                        {
                            if (num15 != ignoreClient && (NetMessage.buffer[num15].broadcast || (Netplay.serverSock[num15].state >= 3 && msgType == 100 + 10)) && Netplay.serverSock[num15].tcpClient.Connected)
                            {
                                bool flag2 = false;
                    ...
                    if (msgType == 13)
                    {
                        ...
                        {
                            if (num16 != ignoreClient && (NetMessage.buffer[num16].broadcast || (Netplay.serverSock[num16].state >= 3 && msgType == 100 + 10)) && Netplay.serverSock[num16].tcpClient.Connected)
                            {
                                bool flag3 = false;
                    ...
                    else
                    {
                        if (msgType == 100 + 27)
                        {
                            ...
                            {
                                if (num17 != ignoreClient && (NetMessage.buffer[num17].broadcast || (Netplay.serverSock[num17].state >= 3 && msgType == 100 + 10)) && Netplay.serverSock[num17].tcpClient.Connected)
                                {
                                    bool flag4 = false;
                        ...
                        {
                            if (num18 != ignoreClient && (NetMessage.buffer[num18].broadcast || (Netplay.serverSock[num18].state >= 3 && msgType == 100 + 10)) && Netplay.serverSock[num18].tcpClient.Connected)
                            {
                                try
                                {
            ...
            IL_4A54:
                ...
                if (msgType == 100 + 19 && Main.netMode == 1)
                {
                    int size = 5;
                    SendPackets.SendTileSquare(num, (int)number2, (int)number3, size);
                }
                if (msgType == 100 + 2 && Main.netMode == 2)
                {
        ...
        public static void SendTileSquare2(int whoAmi, int tileX, int tileY, int size)
        {
            int num = (size - 1) / 2;
            SendPackets.SendData(161, whoAmi, -1, "", size, (float)(tileX - num), (float)(tileY - num), 0f, 0);
        }
        public static void BootPlayer(int plr, string msg)
        {
            SendPackets.SendData(2, plr, -1, msg, 0, 0f, 0f, 0f, 0);
        }
